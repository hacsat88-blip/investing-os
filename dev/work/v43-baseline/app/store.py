...
NUMBERS = {'quantity','avgCost','costBasisJpy','price','fx','marketValueJpy','pnlJpy','weight','pts','ptsVolume','close','stars'}
SIGNED = {'pnlJpy'}
...
class Store:
    ...
    def commit(self, tables, version, actor, reason):
        ...
        with self.lock():
            ...
            meta={'version':vid,'parent':version,'savedAt':now(),'actor':actor,'reason':reason,'hashes':hashes,'changes':changes,'schemaVersion':'4.2'}
